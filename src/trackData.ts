...
export const TRACK_DATA: TrackRow[] = [
  ...
  { typeid1: '#0-6-1', typeid:'#0-6',type: '24 inch 90D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-2', typeid:'#0-6',type: '24 inch 45D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-3', typeid:'#0-6',type: '24 inch 22.5D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-4', typeid:'#0-6',type: '24 inch 11.25D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-5', typeid:'#0-6',type: '30 inch 90D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-6', typeid:'#0-6',type: '30 inch 45D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-7', typeid:'#0-6',type: '30 inch 22.5D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
  { typeid1: '#0-6-8', typeid:'#0-6',type: '30 inch 11.25D-Bend', geometry: 'point', unitprice: 31762.00, color: 'purple', unit: "EA"   },
